...
# def initiate_data_trabsformation(self,train_path,test_path):
#     try:
...
#         numerical_columns=["writing_score","reading_score"]
#         # divide the train data set into independent and dependent feature
...
#         logging.info("Applying train and test data transform")
...
#         save_object(
#             file_Path=self_data_transformation_config.preprocessor_obj_file_path,
